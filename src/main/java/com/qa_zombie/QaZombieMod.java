...
@Mod("qa_zombie")
public class QaZombieMod {
	public static final Logger LOGGER = LogManager.getLogger(QaZombieMod.class);
	public static final String MODID = "qa_zombie";

	public QaZombieMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		QaZombieModVariables.ATTACHMENT_TYPES.register(modEventBus);
